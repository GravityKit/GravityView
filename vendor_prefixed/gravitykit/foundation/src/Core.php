		...
		add_filter(
			...
			function ( $plugins ) {
				...
				if ( defined( 'GV_PLUGIN_VERSION' ) && version_compare( GV_PLUGIN_VERSION, '2.16', '<' ) ) {
					...
					$notice_2 = strtr(
						esc_html__( 'As such, the settings below will not apply to GravityView pages and you will have to continue using the [link]old settings[/link] until an updated version of the plugin is available. We apologize for the inconvenience as we work to update our products in a timely fashion.', 'gk-foundation' ),
						[
				...
				$general_settings = array_merge(
					...
					[
						...
						[
							...
							'description' => strtr(
								esc_html__( 'Earn money when people clicking your links become GravityKit customers. [link]Register as an affiliate[/link]!', 'gk-foundation' ),
								[
				...
				$support_settings = [
					...
					[
						...
						'description' => ( esc_html__( 'The Support Port provides quick access to how-to articles and tutorials. For administrators, it also makes it easy to contact support.', 'gk-foundation' ) .
						                   strtr(
							                   esc_html__( '[image]Support Port icon[/image]', 'gk-foundation' ),
							                   [
