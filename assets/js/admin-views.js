...
(function( $ ) {
   ...
   var viewConfiguration, viewGeneralSettings;
	...
	// Ensure gform.applyFilters exists (needed for merge tags compatibility and Fix conflict with Yoast)
	window.gform = window.gform || {};
	window.gform.applyFilters = window.gform.applyFilters || function (a, v) { return v; };
