...
jQuery( document).ready(function( $ ){
    ...
    gvWidgets = {
        ...
        init: function() {
            ...
            $( document )
                .on( 'widget-added widget-updated widget-toggled', gvWidgets.modified )
                .on('change refresh', '#widgets-right .gv-recent-entries-select-view', gvWidgets.refreshMergeTags );
