...
(function( $ ) {
	...
	window.GVToast = {
		...
		show: function( message, type, duration ) {
			...
			// Build toast DOM structure safely to prevent XSS
			var $toast = $(
			...
			// Add message safely using .text() to escape HTML
			$toast
				.find( '.gv-toast-content' )
				.append(
					$( '<span class="gv-toast-message"></span>' ).text( message )
				);
