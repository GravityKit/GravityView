...
EOD;
			$access_key_output   = sprintf(
				...
				/* %2$s */ esc_html__( 'Error', 'gravityview' ),
				/* %3$s */ 'div',
				/* %4$s */ esc_html__( 'There was an error returning the access key.', 'gravityview' ),
...
EOD;
			$access_key_output   = sprintf(
				...
				/* %8$s */ sprintf( esc_html__( 'The access key is not a password; only %1$s will be able to access your site using this code. You may share this access key on support forums.', 'gravityview' ), $this->support_user->get_first()->display_name )
			);
