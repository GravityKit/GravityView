...
final class SupportUser
{
    ...
    /**
     * @var string The namespaced setting name for storing the unique identifier hash in user meta
     *
     * @since 1.0.0
     *
    ...
    /**
     * @var string The namespaced setting name for storing the site identifier hash in user meta
     *
     * @since 1.0.0
     *
    ...
    /**
     * @var int The namespaced setting name for storing the timestamp the user expires
     *
     * @since 1.0.0
     *
    ...
    /**
     * @var int The ID of the user who created the TrustedLogin access
     *
     * @since 1.0.0
     */
    ...
    private function login(WP_User $support_user)
    {
         ...
         */
        do_action('trustedlogin/'.$this->config->ns().'/logged_in', [
            'url'    => get_site_url(),
            'action' => 'logged_in',
        ]);
    }
    ...
    public function delete($user_identifier = '', $delete_role = true, $delete_endpoint = true)
    {
        ...
        wp_clear_scheduled_hook('trustedlogin/'.$this->config->ns().'/access/revoke', [$user_identifier]);
