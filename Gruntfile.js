		...
		sass: {
			...
			dist: {
				files: [{
		          expand: true,
		          cwd: 'assets/css/scss',
		          src: ['*.scss','!gf-merge-tags-*.scss','!admin-merge-tags.scss','!admin-tooltips.scss','!admin-metabox-panel.scss','!admin-metabox.scss','!admin-metabox-placeholder.scss','!admin-members-plugin.scss','!variables.scss', '!admin-refresh.scss'],
		          dest: 'assets/css',
		          ext: '.css'
		      }]
			},
