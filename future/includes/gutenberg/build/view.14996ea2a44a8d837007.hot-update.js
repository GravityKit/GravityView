...
function Edit(_ref) {
  ...
  /**
   * Sets the selected Sort Field.
   *
   * @since TBD
   *
   * @param {number} _viewId The View ID.
   */
  function selectSortField(_viewId) {
    var selectedView = gkGravityViewBlocks.views.find(function (option) {
      return option.value === _viewId;
    });
    setAttributes({
  ...
  }), "console.log(selectedSortField);", (0,react__WEBPACK_IMPORTED_MODULE_2__.createElement)(shared_js_sort_selector__WEBPACK_IMPORTED_MODULE_8__["default"], {
    viewId: viewId,
    isSidebar: true
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "bb377e7429d3a9e665b0"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=view.14996ea2a44a8d837007.hot-update.js.map