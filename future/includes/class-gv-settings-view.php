	...
	public static function defaults( $detailed = false, $group = null ) {
		$default_settings = array_merge(
			array(
				...
				'grid_gap' => array(
					'label'             => __( 'Grid Gap (in pixels)', 'gk-gravityview' ),
					'group'             => 'appearance',
					'class'             => 'widefat',
					'type'              => 'number',
					'value'             => '10',
				...
				'grid_min_width' => array(
					'label'             => __( 'Minimum Width (in pixels)', 'gk-gravityview' ),
					'group'             => 'appearance',
					'type'              => 'number',
					'value'             => '250',
					'min'               => 1,
				...
				'grid_columns' => array(
					'label'             => __( 'Columns', 'gk-gravityview' ),
					'group'             => 'appearance',
					'type'              => 'number',
					'value'             => '3',
					'min'               => 1,
