...
class Entry_Renderer extends Renderer {
	...
	public function render( Entry $entry, View $view, Request $request = null ) {
		...
		/**
		 * @hook gravityview_render_entry_{View ID} Before rendering a single entry for a specific View ID
		 * @since 1.17
		 *
		 * @since 2.0
		...
		/**
		 * @hook gravityview/template/entry/class Filter the template class that is about to be used to render the entry.
		 * @since 2.0
