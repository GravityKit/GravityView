...
abstract class Extension {
	 ...
	 */
	static public $is_compatible = true;
	...
	protected function is_extension_supported() {
		if ( ! function_exists( 'gravityview' ) ) {
			...
			$message = '';
			self::$is_compatible = gravityview()->plugin->is_compatible();
		}
	...
	public function settings() {
		...
		if ( ! class_exists( 'EDD_SL_Plugin_Updater' ) || false === $license || empty( $license['status'] ) || strtolower( $license['status'] ) !== 'valid' ) {
			return;
		}
