...
abstract class Entry
{
    ...
    public static function add_rewrite_endpoint()
    {
        ...
        if (in_array([EP_PERMALINK | EP_PERMALINK | EP_ROOT, $endpoint, $endpoint], $wp_rewrite->endpoints)) {
            return;
        }
     ...
     * @param bool          $track_directory Keep the housing directory arguments intact (used for breadcrumbs, for example). Default: true.
     *
