...
class GV_Unit_Tests_Bootstrap
{
    ...
    public function __construct()
    {
        ...
        tests_add_filter('pre_http_request', [$this, 'mock_http'], 10, 3);
        ...
        if (in_array('--debug', (array) $_SERVER['argv'], true) && in_array('--verbose', (array) $_SERVER['argv'], true)) {
            tests_add_filter('gravityview_log_error', [$this, 'test_print_log'], 10, 2);
            tests_add_filter('gravityview_log_debug', [$this, 'test_print_log_backtrace'], 10, 2);
        }
