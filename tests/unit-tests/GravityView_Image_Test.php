...
class GravityView_Image_Test extends GV_UnitTestCase
{
     ...
     */
    public function get_loaded_image()
    {
     ...
     */
    public function test_validate_image_src()
    {
        $Image = new GravityView_Image();
        ...
        add_filter('gravityview_image_extensions', [$this, 'get_extensions']);
        ...
        remove_filter('gravityview_image_extensions', [$this, 'get_extensions']);
    }
     ...
     * @return array
     */
    public function get_extensions($group = 'all')
    {
        $valid_extensions = ['jpg', 'jpeg', 'jpe', 'gif', 'png', 'bmp', 'tif', 'tiff', 'ico', 'webp'];
        $invalid_extensions = ['nope', 'wontwork', 'notimage', 'ursilly'];
