...
class GravityView_Cache_Test extends GV_UnitTestCase
{
    ...
    public function test_cache_multi()
    {
        ...
        $cache3 = new GravityView_Cache([1]);

        $this->assertEquals('Go flight.', $cache->get());

        $cache4 = new GravityView_Cache([0]);
