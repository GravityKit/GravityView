...
class GravityView_GVLogic_Shortcode_Test extends GV_UnitTestCase
{
    ...
    public function test_comparisons($shortcode = 'gvlogic')
    {
        $correct = [
            'if="4" is="4"',
            'if="4" is="3||4"',
    ...
    public function test_basic_if_else()
    {
     ...
     * @since 2.0
     */
    public function test_register_another_gvlogic_shortcode()
    {
        $GVLogic_Shortcode = GVLogic_Shortcode::get_instance();
        $GVLogic_Shortcode->shortcode = 'gvlogic2';

        add_shortcode('gvlogic2', [$GVLogic_Shortcode, 'shortcode']);
     ...
     */
    public function test_recursive_do_shortcode()
    {
     ...
     * @since 2.9.4
     */
    public function test_get_merge_tag()
    {
        unset($_GET['example']);
     ...
     */
    public function test_gv_shortcode_for_user_meta()
    {
     ...
     */
    public function test_gv_shortcode_for_user_id_logged_in()
    {
        $this->expected_deprecated[] = 'WP_User->id';
     ...
     */
    public function test_gv_shortcode_date_comparison($date1, $date2, $op, $result)
    {
        $form_id = \GFAPI::add_form([
            'title'  => __FUNCTION__,
            'fields' => [
                ['id' => 1, 'label' => 'Date 1', 'type'  => 'date'],
                ['id' => 2, 'label' => 'Date 2', 'type'  => 'date'],
            ],
        ]);
    ...
    public function get_test_gv_shortcode_date_comparison()
    {
        return [
            ['2019-01-13', '2019-01-13', 'equals', true],
            ['2019-01-14', '2019-01-13', 'equals', false],
            ['2019-01-14', '2019-01-13', 'isnot', true],
            ['2019-01-14', '2019-01-14', 'isnot', false],
            ['2019-01-11', '2019-01-14', 'greater_than', false],
            ['2019-01-11', '2019-01-14', 'less_than', true],
            ['2019-01-17', '2019-01-14', 'greater_than_or_is', true],
            ['2019-01-17', '2019-01-14', 'less_than_or_is', false],
        ];
    }
     ...
     */
    public function test_gv_shortcode_date_comparison_format($date1, $date2, $op, $result)
    {
        $form_id = \GFAPI::add_form([
            'title'  => __FUNCTION__,
            'fields' => [
                ['id' => 1, 'label' => 'Date 1', 'type'  => 'date', 'date_format' => 'mdy'],
                ['id' => 2, 'label' => 'Date 2', 'type'  => 'date', 'date_format' => 'ymd_slash'],
            ],
        ]);
        $form = \GV\GF_Form::by_id($form_id);
    ...
    public function get_test_gv_shortcode_date_comparison_format()
    {
        return [
            ['2019-01-13', '2019-01-13', 'equals', true],
            ['2019-01-14', '2019-01-13', 'equals', false],
    ...
    public function test_gv_shortcode_loggedin()
    {
        $form_id = \GFAPI::add_form([
            'title'  => __FUNCTION__,
            'fields' => [
                ['id' => 1, 'label' => 'Text', 'type'  => 'text'],
            ],
        ]);
        $form = \GV\GF_Form::by_id($form_id);
     ...
     */
    public function test_gv_shortcode_nested_gvlogic2()
    {
        $GVLogic_Shortcode = GVLogic_Shortcode::get_instance();
        $GVLogic_Shortcode->shortcode = 'gvlogic2';
