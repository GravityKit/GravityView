...
class GravityView_Merge_Tags_Test extends GV_UnitTestCase
{
     ...
     */
    public function test_replace_user_variables_created_by()
    {
     ...
     */
    public function test_replace_current_post()
    {
        global $post;
     ...
     */
    public function test_process_modifiers()
    {
        $tests = [
            [
                'modifier' => 'maxwords:4',
     ...
     * @group date_created
     */
    public function test_replace_date_created_and_updated($date_field = 'date_created')
    {
        $form = $this->factory->form->create_and_get();
    ...
    public function test_replace_date_updated()
    {
     ...
     * @since 1.16
     */
    public function test_replace_field_custom_merge_tags()
    {
        $form = $this->factory->form->create_and_get();
     ...
     * @covers GravityView_Merge_Tags::replace_gv_merge_tags()
     */
    public function test_replace_get_variables()
    {
     ...
     * @since 2.0
     */
    public function test_merge_tag_data()
    {
        $form = $this->factory->form->create_and_get();
        $post = $this->factory->post->create_and_get();
        ...
        $form['fields'][] = new GF_Field_Text(['id' => 100, 'form_id' => $form['id']]);
        $form['fields'][] = new GF_Field_Text(['id' => 101, 'form_id' => $form['id']]);
        $form['fields'][] = new GF_Field_Text(['id' => 201, 'form_id' => $form['id']]);
        $form['fields'][] = new GF_Field_Text(['id' => 301, 'form_id' => $form['id']]);

        $list_field = new GF_Field_List(['id' => 401, 'form_id' => $form['id']]);
     ...
     * @since 2.10.1
     */
    public function test_replace_site_url()
    {
     ...
     * @since 1.15.1
     */
    public function test_gf_merge_tags()
    {
        $form = $this->factory->form->create_and_get();
        $post = $this->factory->post->create_and_get();
        $entry = $this->factory->entry->create_and_get(['post_id' => $post->ID, 'form_id' => $form['id']]);
        ...
        foreach ($tests as $merge_tag => $expected) {
            ...
            remove_filter('gform_replace_merge_tags', ['GravityView_Merge_Tags', 'replace_gv_merge_tags'], 10);
            ...
            add_filter('gform_replace_merge_tags', ['GravityView_Merge_Tags', 'replace_gv_merge_tags'], 10, 7);
        }
