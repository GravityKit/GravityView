...
class GravityView_Uninstall_Test extends GV_UnitTestCase
{
     ...
     */
    public function test_fire_everything()
    {
        $create_count = 10;
        ...
        $views = $this->factory->view->create_many($create_count, ['form_id' => $form['id']]);

        $entry_ids = $this->factory->entry->create_many($create_count, ['form_id' => $form['id'], 'date_created' => '2013-11-28 11:00', '1' => 'Second Choice', '2.2' => 'Second Choice', '8' => '1', '13.6' => 'Spain']);
        ...
        $user = $this->factory->user->create_and_set([
     ...
     * @param $entry_ids
     */
    public function _check_deleted_entry_meta($entry_ids)
    {
        $values = gform_get_meta_values_for_entries($entry_ids, ['is_approved', 'do_not_delete']);
     ...
     * @since 1.15
     */
    public function _check_posts()
    {
        // All the Views should be deleted
        $views = get_posts([
            'post_type' => 'gravityview',
        ]);
        $this->assertEquals([], $views);
    }
     ...
     * @param $create_count
     */
    public function _check_entries($form, $create_count)
    {
     ...
     * @param $entry_ids
     */
    public function _check_deleted_entry_notes($entry_ids)
    {
     ...
     * @since 1.15
     */
    public function _check_deleted_options($should_be_empty = true)
    {
        $options = [
     ...
     * @param $form
     */
    public function _set_up_entry_meta($entry_ids, $form)
    {
     ...
     * @param $entry_ids
     */
    public function _set_up_notes($entry_ids)
    {
     ...
     * @since 1.15
     */
    public function _set_up_gravityview_settings()
    {
     ...
     * @since 1.15
     */
    public function _set_up_expected_options()
    {
