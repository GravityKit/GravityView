...
class GravityView_Render_Settings_Test extends GV_UnitTestCase
{
    ...
    public function test_render_field_options()
    {
        ...
        $output = GravityView_Render_Settings::render_field_options($form['id'], 'field', 'default_table', '12', 'Example Field Label', 'directory_table-columns', 'multiselect', 'UNIQID_EXAMPLE', '', 'single', []);
        ...
        add_filter('gravityview_template_field_options', $_change_field_options = function ($default_options = []) {
    ...
    public function test_get_default_field_options()
    {
        ...
        add_filter('gravityview_template_widget_options', $_filter_widget_options = function ($options) {
            return ['custom_option' => ['type' => 'text', 'value' => 'GRATE IDEA']];
        });
