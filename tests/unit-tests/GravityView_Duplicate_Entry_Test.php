...
class GravityView_Duplicate_Entry_Test extends GV_UnitTestCase
{
     ...
     */
    public function test_get_duplicate_link()
    {
    ...
    public function test_get_duplicate_link_loop()
    {
        ...
        foreach ($posts as $_post) {
            ...
            $this->assertEquals($expected, remove_query_arg(['duplicate'], $duplicate_link_with_post));
        }
    ...
    {
        $template_paths = GravityView_Duplicate_Entry::getInstance()->add_template_path([]);
    ...
    public function test_check_user_cap_duplicate_entry()
    {
        ...
        $this->assertTrue(GravityView_Duplicate_Entry::check_user_cap_duplicate_entry($entry, [], $view->ID));

        $view_user_duplicate_disabled = $this->factory->view->create_and_get([
            'form_id'  => $form['id'],
            'settings' => [
        ...
        $this->assertFalse(GravityView_Duplicate_Entry::check_user_cap_duplicate_entry($entry, [], $view_user_duplicate_disabled->ID));
        ...
        // Admin always can duplicate
        $this->assertTrue(GravityView_Duplicate_Entry::check_user_cap_duplicate_entry($entry, [], $view_user_duplicate_disabled->ID));
        ...
        $this->assertTrue(GravityView_Duplicate_Entry::check_user_cap_duplicate_entry($entry_without_created_by, [], $view_user_duplicate_disabled->ID));

        $this->factory->user->set($contributor_id);

        $this->assertFalse(GravityView_Duplicate_Entry::check_user_cap_duplicate_entry($entry_without_created_by, [], $view->ID));
    }
    ...
    public function _add_and_remove_caps_test($entry, $view)
    {
        ...
        foreach ($full_access as $cap) {
            ...
            $this->assertFalse(GravityView_Duplicate_Entry::check_user_cap_duplicate_entry($entry, [], $view->ID), $cap);
            ...
            $this->assertTrue(GravityView_Duplicate_Entry::check_user_cap_duplicate_entry($entry, [], $view->ID), $cap);
        }
    }
