...
class GravityView_View_Test extends GV_UnitTestCase
{
     ...
     */
    public function test_BackLinkLabel()
    {
     ...
     */
    public function test_TotalEntries()
    {
     ...
     */
    public function test_getPaginationCounts()
    {
        $GV = GravityView_View::getInstance();
        ...
        $this->assertEquals(['first' => 26, 'last' => 50, 'total' => 100], $GV->getPaginationCounts());
    }

    /**
     * @covers GravityView_View::add_id_specific_templates
     */
    public function test_add_id_specific_templates()
    {
        ...
        $templates_before = ['table-header.php'];
