...
class GravityView_Edit_Entry_Test extends GV_UnitTestCase
{
    ...
    public function test_get_edit_link()
    {
        ...
        $editor = $this->factory->user->create_and_set([
            'user_login' => 'editor',
            'role'       => 'editor',
        ]);
    ...
    public function test_get_edit_link_loop()
    {
        ...
        $a_post = $this->factory->post->create_and_get([
            'post_content' => 'This is a post',
        ]);

        $view_post = $this->factory->post->create_and_get([
        ...
        $another_view = $this->factory->view->create_and_get([
            'form_id'  => $another_form['id'],
            'settings' => [
                'user_edit' => 1,
            ],
        ...
        $another_post = $this->factory->post->create_and_get([
            'post_content' => 'This is a post',
        ]);

        $another_view_post = $this->factory->post->create_and_get([
        ...
        $and_another_view = $this->factory->view->create_and_get([
            'form_id'  => $another_form['id'],
            'settings' => [
                'user_edit' => 1,
            ],
        ...
        $posts = [$a_post, $view_post, $another_post, $another_view_post, $and_another_view];
        ...
        foreach ($posts as $_post) {
            ...
            $this->assertEquals($expected, remove_query_arg(['edit', 'gvid'], $edit_link_with_post));
        }
    ...
    {
        $template_paths = GravityView_Edit_Entry::getInstance()->add_template_path([]);
    ...
    public function test_check_user_cap_edit_entry()
    {
        ...
        $view_user_edit_enabled = $this->factory->view->create_and_get([
            'form_id'  => $form['id'],
            'settings' => [
                'user_edit' => 1,
            ],
        ...
        $view_user_edit_disabled = $this->factory->view->create_and_get([
            'form_id'  => $form['id'],
            'settings' => [
                'user_edit' => 0,
            ],
        ...
        $contributor = $this->factory->user->create_and_get([
        ...
        $entry_without_created_by = $this->factory->entry->create_and_get([
            'form_id'    => $form['id'],
            'created_by' => $contributor_id,
        ]);
    ...
    {
        $user = $this->factory->user->create_and_set(['role' => 'zero']);
    ...
    private function _emulate_render($form, $view, $entry)
    {
        ...
        return [$rendered_form, $render, GFAPI::get_entry($entry['id'])];
    }
    ...
    public function test_edit_entry_render()
    {
        ...
        foreach ($form['fields'] as $field) {
            /** Emulate a $_POST */
            foreach ($field->inputs ?: [['id' => $field->id]] as $input) {
    ...
    public function test_edit_entry_upload()
    {
        ...
        $_POST = [
            'gform_uploaded_files' => json_encode(['input_1' => $entry['1']]),
            'input_2'              => '40',
            'input_3'              => '',
        ];
        list($output, $render, $entry) = $this->_emulate_render($form, $view, $entry);
        ...
        $_FILES = [
            'input_1' => ['name' => 'sleep.txt', 'type' => 'text', 'size' => 3, 'tmp_name' => $tmp_name, 'error' => UPLOAD_ERR_OK],
        ];
    ...
    public function test_edit_entry_post_image()
    {
        ...
        $_FILES['input_1'] = ['name' => '', 'type' => '', 'size' => 0, 'tmp_name' => '', 'error' => UPLOAD_ERR_NO_FILE];
    ...
    public function test_restore_display_name()
    {
        ...
        $user_before_update = $this->factory->user->create_and_get([
        ...
        $should_be_null = $registration->restore_display_name($user_id, $config, [], '');
        ...
        $this->factory->user->update_object($user_id, ['display_name' => 'Changed During Update']);
        ...
        // Update the user
        $should_be_int_user_id = $registration->restore_display_name($user_id, $config, [], '');
        ...
        $should_be_wp_error = $registration->restore_display_name($user_id, $config, [], '');
        ...
        $should_be_false = $registration->restore_display_name($user_id, $config, [], '');
    ...
    public function test_edit_entry_ur_generate_display_names()
    {
        ...
        $complete_subscriber = $this->factory->user->create_and_get([
            'user_login'   => $microtime,
            'user_email'   => $microtime.'@gravityview.tests',
            'display_name' => 'Zeek LaBeek',
            'nickname'     => 'Zeekary',
    ...
    public function test_edit_entry_registration()
    {
        ...
        $form = $this->factory->form->create_and_get();
        $entry = $this->factory->entry->create_and_get(['form_id' => $form['id'], 'status' => 'publish', 'created_by' => $subscriber]);
        $view = $this->factory->view->create_and_get(['form_id' => $form['id']]);
    ...
    public function test_unapprove_on_edit()
    {
        ...
        $view->settings->update(['unapprove_edit' => true]);
    ...
    public function get_redirect_after_edit_data()
    {
        $custom_url = 'https://gravityview.co/floaty-loves-you/?with=<>&wild[]=! &characters=",';

        return [
            ['', false],
            ['0', '' /** homepage; the view is here */],
            ['1', '{permalink}'],
            ['2', $custom_url, $custom_url],
        ];
    }

    public function test_hidden_conditional_edit_simple_conditioned_not_visible()
    {
        $this->_reset_context();
    ...
    public function test_hidden_conditional_edit_simple_conditioned_visible()
    {
        $this->_reset_context();
    ...
    public function test_edit_entry_feeds()
    {
        ...
        $feed_id = GFAPI::add_feed($form['id'], [], 'GravityView_Edit_Entry_Test_Feed');
        ...
        $this->assertEquals([$entry['id']], GravityView_Edit_Entry_Test_Feed::$processed);
    ...
    public function test_hidden_calculations()
    {
        ...
        $form['fields'][2]->conditionalLogic = [
            'rules' => [
                [
                    'fieldId'  => '1',
                    'value'    => 99, // Hide if 99
    ...
    public function test_hidden_conditional_unrelated_field_cache_prefill()
    {
        $this->_reset_context();
    ...
    public function test_hidden_conditional_reset_hidden_value_once_more()
    {
        $this->_reset_context();
    ...
    public function test_partial_form_after_update()
    {
        $this->_reset_context();
    ...
    public function test_approval_transitions()
    {
        $this->_reset_context();
    ...
    public function test_validation_of_required_fields_with_conditional_logic()
    {
        ...
        $form['fields'][7]->conditionalLogic = [
            'rules' => [
                [
                    'fieldId'  => '2.1',
                    'value'    => 'choice 2',
