...
class GravityView_Field_Test extends GV_UnitTestCase
{
     ...
     * @group gvajax
     */
    public function test_Transaction_Type_get_content()
    {
     ...
     * @group gvajax
     */
    public function test_Is_Fulfilled_get_content()
    {
     ...
     */
    public function test_GravityView_Field_Post_Image_explode_value()
    {
        ...
        $expected_missing_url_array_value = [
            'url'         => '',
            'title'       => 'example title',
            'caption'     => 'example caption',
            'description' => 'example description',
        ...
        $expected_missing_title_array_value = [
            'url'         => 'http://example.com',
            'title'       => '',
            'caption'     => 'example caption',
            'description' => 'example description',
        ...
        $expected_missing_all_but_description_array_value = [
            'url'         => '',
            'title'       => '',
            'caption'     => '',
            'description' => 'example description',
     ...
     */
    public function test_GravityView_Field_Other_Entries_get_entries()
    {
        ...
        $null_entry = \GV\GF_Entry::from_entry($this->factory->entry->create_and_get([
            'form_id'    => $form['id'],
            'created_by' => 0,
            'status'     => 'active',
        ]));
        ...
        $another_entry = \GV\GF_Entry::from_entry($this->factory->entry->create_and_get([
            'form_id'    => $form['id'],
            'created_by' => $user_1,
            'status'     => 'active',
        ]));
        ...
        $and_another_entry = \GV\GF_Entry::from_entry($this->factory->entry->create_and_get([
            'form_id'    => $form['id'],
            'created_by' => $user_1,
            'status'     => 'active',
        ]));
         ...
         * Filter by date.
         */
        $valid_date_entry = \GV\GF_Entry::from_entry($this->factory->entry->create_and_get([
            'form_id'      => $form['id'],
            'created_by'   => $user_1,
            'status'       => 'active',
    ...
    public function test_GravityView_Field_Sequence()
    {
    ...
    public function test_GravityView_Field_Sequence_single()
    {
        $form = $this->factory->form->import_and_get('simple.json');
        $post = $this->factory->view->create_and_get([
            'form_id'     => $form['id'],
    ...
    public function test_GravityView_Field_Unsubscribe_render_permissions()
    {
        ...
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', null, null, null));
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => -1], null, null));
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $administrator], null, null));
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $author], null, null));
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $author, 'id' => 1], ['unsub_all' => true], null));
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $author, 'id' => 1, 'payment_status' => 'null'], ['unsub_all' => true], null));

        $this->assertContains('Unsubscribe', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $author, 'id' => 1, 'payment_status' => 'active'], ['unsub_all' => true], null));
        $this->assertContains('Unsubscribe', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $administrator, 'id' => 1, 'payment_status' => 'active'], null, null));
        ...
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $administrator], null, null));
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $author], null, null));
        $this->assertEquals('sentinel', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $author, 'id' => 1, 'payment_status' => 'null'], null, null));

        $this->assertContains('Unsubscribe', $field->modify_entry_value_unsubscribe('sentinel', ['created_by' => $author, 'id' => 1, 'payment_status' => 'active'], null, null));

        wp_set_current_user(0);
    }

    public function test_GravityView_Field_Unsubscribe_unsubscribe_permissions()
    {
        $form = $this->factory->form->import_and_get('simple.json');
        ...
        $feed_id = \GFAPI::add_feed($form['id'], ['transactionType' => 'subscription'], 'gf_paymentaddon_test');

        gform_update_meta($entry['id'], 'processed_feeds', ['gf_paymentaddon_test' => [$feed_id]]);
