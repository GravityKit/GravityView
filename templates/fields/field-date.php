...
if ( $value === '1970-01-01' ) {
	...
	/**
	 * @hook gravityview/fields/date/hide_epoch Whether to hide `1970-01-01` dates; that is normally an erroneous date. Return false to show value. Use `__return_false` callback.
