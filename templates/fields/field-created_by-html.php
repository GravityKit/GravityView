...
switch (true) {
    // column
    case in_array($name_display, ['ID', 'user_login', 'display_name', 'user_email', 'user_registered'], true):
        echo esc_html($user->$name_display);
        break;
    // meta
    case in_array($name_display, ['nickname', 'description', 'first_name', 'last_name']):
