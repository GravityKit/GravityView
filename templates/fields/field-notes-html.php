...
if (!GVCommon::has_cap(['gravityview_view_entry_notes', 'gravityview_add_entry_notes', 'gravityview_delete_entry_notes']) && !$show_notes_logged_out) {
    return;
}
...
<?php
    ...
    if ($show_add) {
        echo GravityView_Field_Notes::get_add_note_part([], $gravityview);
    }
?>
</div>
