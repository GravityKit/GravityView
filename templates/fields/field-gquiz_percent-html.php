 ...
 * @hook gravityview/field/quiz_percent/format
 * @see https://php.net/manual/en/function.sprintf.php For formatting guide
 ...
 * @param {\GV\Template_Context} $gravityview The context. Added 2.0.
 */
