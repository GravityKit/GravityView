...
<div class="<?php gv_container_class('gv-list-container gv-list-single-container'); ?>">
    ...
    } // End foreach $this->getEntries() and $this->getContextFields()?>
