...
class GravityView_Field_Post_Category extends GravityView_Field
{
    ...
    public $_gf_field_class_name = 'GF_Field_Post_Category';
    ...
    public function __construct()
    {
        ...
        add_action('gravityview/edit-entry/render/before', [$this, 'add_edit_entry_post_category_choices_filter']);

        add_action('gravityview/edit-entry/render/after', [$this, 'remove_edit_entry_post_category_choices_filter']);

        add_action('gravityview/edit_entry/after_update', [$this, 'set_post_categories'], 10, 2);
     ...
     */
    public function set_post_categories($form = [], $entry_id = 0)
    {
     ...
     * @return void
     */
    public function add_edit_entry_post_category_choices_filter()
    {
        add_filter('gform_post_category_choices', [$this, 'edit_entry_post_category_choices'], 10, 3);
    }
     ...
     * @return void
     */
    public function remove_edit_entry_post_category_choices_filter()
    {
        remove_filter('gform_post_category_choices', [$this, 'edit_entry_post_category_choices'], 10);
    }
     ...
     * @return mixed
     */
    public function edit_entry_post_category_choices($choices, $field, $form_id)
    {
