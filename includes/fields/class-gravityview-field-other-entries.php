...
class GravityView_Field_Other_Entries extends GravityView_Field
{
    ...
    public function get_entries($context)
    {
        ...
        foreach ($remove as $r) {
            ...
            $removed[] = [$filter, $priority, $id, $wp_filter[$filter]->callbacks[$priority][$id]];
        ...
        remove_action('gravityview/view/query', [$this, 'gf_query_filter']);
        remove_filter('gravityview_fe_search_criteria', [$this, 'filter_entries']);
