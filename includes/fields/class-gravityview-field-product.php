...
class GravityView_Field_Product extends GravityView_Field
{
    ...
    public $_gf_field_class_name = 'GF_Field_Product';
    ...
    public function __construct()
    {
        ...
        add_action('gravityview/edit_entry/after_update', [$this, 'clear_product_info_cache'], 10, 3);
     ...
     * @return void
     */
    public function clear_product_info_cache($form = [], $entry_id = 0, $Edit_Entry_Render = null)
    {
     ...
     */
    public function should_hide_product_fields($entry = [])
    {
