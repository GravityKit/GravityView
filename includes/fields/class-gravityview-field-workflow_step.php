...
class GravityView_Field_Workflow_Step extends GravityView_Field
{
    ...
    {
        add_filter('gravityview_search_field_label', [$this, 'modify_gravityview_search_field_step_label'], 10, 3);

        add_filter('gravityview_widget_search_filters', [$this, 'modify_frontend_search_fields'], 10, 3);

        add_filter('gravityview_field_entry_value_workflow_step', [$this, 'modify_entry_value_workflow_step'], 10, 4);
    }
     ...
     */
    public function modify_entry_value_workflow_step($output, $entry, $field_settings, $field)
    {
     ...
     */
    public function modify_gravityview_search_field_step_label($label = '', $gf_field = null, $field = [])
    {
        $return = $label;
     ...
     */
    public function get_workflow_step($workflow_step_id = 0)
    {
     ...
     * @return array
     */
    public function modify_frontend_search_fields($search_fields = [], GravityView_Widget_Search $widget = null, $widget_args = [])
    {
