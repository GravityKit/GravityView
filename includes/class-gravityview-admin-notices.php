...
class GravityView_Admin_Notices {
	...
	private function check_show_notices() {
		global $pagenow;

		$show_notices = false;

		if( is_multisite() ) {
			$show_notices = $this->check_show_multisite_notices();
		}
	...
	public function admin_notice() {
		...
		if( empty( $notices ) || ! $this->check_show_notices() ) {
			return;
		}
	 ...
	 * @param array $notice Array with `class`, `message`, and `cap` keys. The message is not escaped.
	 * @return void
	 */
