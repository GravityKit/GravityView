...
class GravityView_Edit_Entry_Render {
	...
	private function process_save( $gv_data ) {
		...
		if( $this->is_valid ) {
			...
			/**
			 * @hook gravityview/edit_entry/before_update Perform an action before the entry has been updated using Edit Entry
			 * @since 2.1
			...
			/**
			 * @hook gravityview/edit_entry/after_update Perform an action after the entry has been updated using Edit Entry
	...
	private function unset_hidden_field_values() {
		...
		/**
		 * @hook gravityview/edit_entry/unset_hidden_field_values Whether to delete values of fields hidden by conditional logic
		 * @since 1.22.2
		...
		<div class="gv-edit-entry-wrapper"><?php
			...
			?><h2 class="gv-edit-entry-title">
				<span><?php
				    ...
				    /**
				     * @hook gravityview_edit_entry_title Modify the edit entry title
	...
	private function maybe_print_message() {
		...
		if ( \GV\Utils::_POST( 'action' ) === 'update' ) {
			...
			if( ! $this->is_valid ){
				...
				/**
				 * @hook gravityview/edit_entry/page/success Modify the edit entry success message on pages
				 * @since develop
				...
				/**
				 * @hook gravityview/edit_entry/success Modify the edit entry success message (including the anchor link)
				 * @since 1.5.4
				 * @param string $entry_updated_message Existing message
				 * @param int $view_id View ID
				 * @param array $entry Gravity Forms entry array
	...
	private function render_edit_form() {
		...
		/**
		 * @hook gravityview/edit-entry/render/before Before rendering the Edit Entry form
		 * @since 1.17
		...
		/**
		 * @hook gravityview/edit-entry/render/after After rendering the Edit Entry form
		 * @since 1.17
		 * @param GravityView_Edit_Entry_Render $this
		 */
	...
	public function verify_user_can_edit_post( $field_content = '', $field, $value, $lead_id = 0, $form_id ) {
        ...
        if( false === current_user_can( 'edit_post', $this->entry['post_id'] ) ) {
            ...
            /**
             * @hook gravityview/edit_entry/unsupported_post_field_text Modify the message when someone isn't able to edit a post
            ...
            /**
             * @hook gravityview/edit_entry/no_post_text Modify the message when someone is editing an entry attached to a post that no longer exists
	...
	private function get_field_value( $field ) {
		...
		/**
		 * @hook gravityview/edit_entry/pre_populate/override Allow the pre-populated value to override saved value in Edit Entry form. By default, pre-populate mechanism only kicks on empty fields.
	    ...
	    /**
	     * @hook gravityview/edit_entry/field_value Change the value of an Edit Entry field, if needed
	     * @since 1.11
	    ...
	    /**
	     * @hook gravityview/edit_entry/field_value_{field_type} Change the value of an Edit Entry field for a specific field type
	     * @since 1.17
	     * @since 1.20 Added third param
	     * @param mixed $field_value field value used to populate the input
	...
	private function get_configured_edit_fields( $form, $view_id ) {
		...
		/**
		 * @hook gravityview/edit_entry/form_fields Modify the fields displayed in Edit Entry form
		 * @since 1.17
	...
	private function filter_fields( $fields, $configured_fields ) {
		...
		if ( empty( $configured_fields ) ) {
			...
			foreach ( $fields as &$field ) {
				...
				/**
				 * @hook gravityview/edit_entry/render_hidden_field
	...
	private function filter_admin_only_fields( $fields = array(), $edit_fields = null, $form = array(), $view_id = 0 ) {
	    ...
	    /**
		 * @hook gravityview/edit_entry/use_gf_admin_only_setting When Edit tab isn't configured, should the Gravity Forms "Admin Only" field settings be used to control field display to non-admins? Default: true
	...
	private function filter_conditional_logic( $form ) {
		...
		/**
		 * @hook gravityview/edit_entry/conditional_logic Should the Edit Entry form use Gravity Forms conditional logic showing/hiding of fields?
		 * @since 1.9
	...
	public function verify_nonce() {
		...
		/**
		 * @hook gravityview/edit_entry/verify_nonce Override Edit Entry nonce validation. Return true to declare nonce valid.
		 * @since 1.13
