...
class GravityView_Edit_Entry
{
    ...
    private function add_hooks()
    {
        ...
        add_action('wp_ajax_nopriv_rg_delete_file', [$this, 'delete_file']);

        // Make sure this hook is run for non-admins
        add_action('wp_ajax_rg_delete_file', [$this, 'delete_file']);

        add_filter('gravityview_blocklist_field_types', [$this, 'modify_field_blocklist'], 10, 2);
    ...
    {
        if (class_exists('GFSignature') && is_callable(['GFSignature', 'get_instance'])) {
            add_filter('gform_admin_pre_render', [GFSignature::get_instance(), 'edit_lead_script']);
        }
    }
    ...
    public static function get_edit_link($entry, $view_id, $post_id = null, $field_values = '')
    {
        ...
        if ($post_id) {
            $url = add_query_arg(['gvid' => $view_id], $url);
        }
     ...
     */
    public function modify_field_blacklist($fields = [], $context = null)
    {
     ...
     * @return array If not edit context, original field blocklist. Otherwise, blocklist including post fields.
     */
    public function modify_field_blocklist($fields = [], $context = null)
    {
     ...
     */
    public function get_field_blacklist($entry = [])
    {
     ...
     * @return array Blocklist of field types
     */
    public function get_field_blocklist($entry = [])
    {
        $fields = [
            'page',
            'payment_status',
         ...
         * @depecated 2.14
         */
        $fields = apply_filters_deprecated('gravityview/edit_entry/field_blacklist', [$fields, $entry], '2.14', 'gravityview/edit_entry/field_blocklist');
    ...
    public static function check_user_cap_edit_entry($entry, $view = 0)
    {
        ...
        // Then we're good.
        if (GVCommon::has_cap(['gravityforms_edit_entries', 'gravityview_edit_others_entries'], $entry['id'])) {
