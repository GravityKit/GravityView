...
class GravityView_Edit_Entry_Admin
{
    ...
    public function load()
    {
        ...
        add_filter('gravityview_template_edit_link_options', [$this, 'edit_link_field_options'], 10, 5);

        // add tooltips
        add_filter('gravityview/metaboxes/tooltips', [$this, 'tooltips']);

        // custom fields' options for zone EDIT
        add_filter('gravityview_template_field_options', [$this, 'field_options'], 10, 6);
    ...
    {
        if ($zone !== 'edit') {
            $entry_default_fields['edit_link'] = [
     ...
     */
    public function edit_link_field_options($field_options, $template_id, $field_id, $context, $input_type)
    {
