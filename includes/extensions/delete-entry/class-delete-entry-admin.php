...
class GravityView_Delete_Entry_Admin
{
    ...
    public function load()
    {
        ...
        add_action('gravityview/metaboxes/delete_entry', [$this, 'view_settings_metabox']);

        // Add Delete Entry settings to Edit Entry Settings Metabox.
        add_action('gravityview/metaboxes/edit_entry', [$this, 'view_settings_edit_entry_metabox'], 20);
        ...
        add_filter('gravityview_template_delete_link_options', [$this, 'delete_link_field_options'], 10, 5);

        // Add Delete Entry settings to View Settings
        add_action('gravityview/metaboxes/delete_entry', [$this, 'view_settings_delete_entry_metabox'], 7);
    ...
    {
        if ('edit' !== $zone) {
            $entry_default_fields['delete_link'] = [
