...
class GravityView_Entry_List {
	...
	public function get_output() {
		...
		/**
		 * @hook gravityview/widget/recent-entries/output Modify the HTML of the Recent Entries widget output
	...
	private function get_item_output( $entry ) {
		...
		/**
		 * @hook gravityview/entry-list/link The link to this other entry now.
		...
		if( !empty( $this->after_link ) ) {
			...
			/**
			 * @hook gravityview/entry-list/after-link Modify the content displayed after the entry link in an entry list
			 * @since 1.7.2
		...
		/**
		 * @hook gravityview/entry-list/item Modify each item's output in an entry list
		 * @since 1.7.2
