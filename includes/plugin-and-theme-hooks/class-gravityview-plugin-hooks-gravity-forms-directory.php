...
class GravityView_Plugin_Hooks_Gravity_Forms_Directory extends GravityView_Plugin_and_Theme_Hooks
{
    ...
    protected function add_hooks()
    {
        ...
        remove_action('admin_init', [$KWS_GF_Change_Lead_Creator, 'set_screen_mode']);

        remove_action('gform_entry_info', [$KWS_GF_Change_Lead_Creator, 'add_select'], 10);

        remove_action('gform_after_update_entry', [$KWS_GF_Change_Lead_Creator, 'update_entry_creator'], 10);
    }
}
