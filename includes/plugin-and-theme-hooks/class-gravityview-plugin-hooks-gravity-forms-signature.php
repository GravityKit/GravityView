...
{
    /**
     * @var string Class that should be exist in a plugin or theme. Used to check whether plugin is active.
     *
     * @since 1.17
     */
    ...
    protected function add_hooks()
    {
        ...
        add_action('gravityview/edit_entry/after_update', [$this, 'after_edit_entry'], 10, 2);
        ...
        add_filter('gform_field_input', [$this, 'edit_entry_field_input'], 5, 5);
    }
     ...
     */
    public function after_edit_entry($form, $entry_id)
    {
     ...
     */
    public function edit_entry_field_input($field_content = '', $field = null, $value = '', $lead_id = 0, $form_id = 0)
    {
