...
{
    /**
     * @var string Optional. Constant that should be defined by plugin or theme. Used to check whether plugin is active.
     *
     * @since 1.17
     */
    ...
    {
        add_filter('gravityview/edit_entry/form_fields', [$this, 'fix_survey_fields'], 10);
        add_action('gravityview/edit-entry/render/before', [$this, 'add_render_hooks']);
        add_action('gravityview/edit-entry/render/after', [$this, 'remove_render_hooks']);

        add_filter('gravityview/extension/search/input_type', [$this, 'modify_search_bar_input_type'], 10, 2);
    }
     ...
     */
    public function modify_search_bar_input_type($input_type = 'text', $field_type = '')
    {
        $return = $input_type;
    ...
    {
        add_filter('gform_field_value', [$this, 'fix_survey_field_value'], 10, 3);
    }
    ...
    {
        remove_filter('gform_field_value', [$this, 'fix_survey_field_value'], 10);
    }
