...
class GravityView_Plugin_Hooks_Yoast_SEO extends GravityView_Plugin_and_Theme_Hooks
{
    ...
    protected function add_hooks()
    {
        ...
        if (gravityview()->request->is_admin('', null)) {
            ...
            add_filter('wpseo_metabox_prio', [$this, 'return_low']);

            // Prevent the SEO from being checked. Eesh.
            add_filter('wpseo_use_page_analysis', '__return_false');

            add_filter('option_wpseo', [$this, 'disable_content_analysis']);

            // WordPress SEO Plugin
            add_filter('option_wpseo_titles', [$this, 'hide_wordpress_seo_metabox']);
        }
    }
     ...
     */
    public function hide_wordpress_seo_metabox($options = [])
    {
        global $pagenow;
     ...
     */
    public function return_low($existing = 'high')
    {
        return 'low';
    }
}
