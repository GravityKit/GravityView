...
class GravityView_Plugin_Hooks_ACF extends GravityView_Plugin_and_Theme_Hooks
{
     ...
     * @var array
     */
    protected $style_handles = ['acf-global'];
    ...
    protected function add_hooks()
    {
        ...
        add_filter('gravityview/view_collection/from_post/meta_keys', [$this, 'add_meta_keys_from_post'], 10, 2);
     ...
     * @return array
     */
    public function add_meta_keys_from_post($meta_keys = [], $post = null)
    {
        ...
        $acf_keys = get_field_objects($post->ID, ['load_value' => false]);
