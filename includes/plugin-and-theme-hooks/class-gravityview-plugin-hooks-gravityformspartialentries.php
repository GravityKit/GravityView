...
class GravityView_Plugin_Hooks_Gravity_Forms_Partial_Entries extends GravityView_Plugin_and_Theme_Hooks
{
    ...
    {
        add_action('gravityview/edit_entry/after_update', [$this, 'maybe_save_partial_entry'], 10, 3);
     ...
     * @return void
     */
    public function maybe_save_partial_entry($form, $entry_id, $edit_entry_render)
    {
        ...
        gravityview()->log->debug('Saving partial entry (ID #{partial_entry_id}) for Entry #{entry_id}', [
