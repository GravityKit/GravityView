...
class GravityView_Plugin_Hooks_Gravity_Forms_Dropbox extends GravityView_Plugin_and_Theme_Hooks
{
    ...
    protected function add_hooks()
    {
        ...
        add_filter('gravityview/fields/fileupload/extension', [$this, 'filter_file_extension']);
        add_filter('gravityview/fields/fileupload/file_path', [$this, 'filter_file_path']);
        add_filter('gravityview/fields/fileupload/image_atts', [$this, 'filter_image_atts']);
    }
     ...
     */
    public function filter_image_atts($image_atts = [])
    {
     ...
     */
    public function filter_file_extension($string = '')
    {
     ...
     * @return string File path or extension, with Dropbox URLs modified
     */
    public function filter_file_path($string = '')
    {
