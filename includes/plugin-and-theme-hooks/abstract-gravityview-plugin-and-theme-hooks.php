...
{
    /**
     * @var string Optional. Class that should be exist in a plugin or theme. Used to check whether plugin is active.
     *
     * @since 1.15.2
     */
    ...
    /**
     * @var string Optional. Function that should be exist in a plugin or theme. Used to check whether plugin is active.
     *
     * @since 1.15.2
     */
    ...
    {
        if ($this->meta_keys) {
            add_filter('gravityview/data/parse/meta_keys', [$this, 'merge_meta_keys'], 10, 2);
        }
