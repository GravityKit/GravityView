...
class GravityView_Plugin_Hooks_Gravity_Flow extends GravityView_Plugin_and_Theme_Hooks
{
    ...
    public function add_hooks()
    {
        ...
        add_filter('gravityview/search/searchable_fields', [$this, 'modify_search_bar_fields_dropdown'], 10, 2);

        add_filter('gravityview/admin/available_fields', [$this, 'maybe_add_non_default_fields'], 10, 3);

        add_filter('gravityview/adv_filter/field_filters', [$this, 'maybe_add_non_default_filter_fields'], 10, 2);
