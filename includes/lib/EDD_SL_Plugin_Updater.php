...
if (!class_exists('EDD_SL_Plugin_Updater')) {
    if (class_exists('\GV\EDD_SL_Plugin_Updater')) {
        require_once dirname(__FILE__).'/EDD_SL_Plugin_Updater_compat.php';
    } else {
        /**
        ...
        class EDD_SL_Plugin_Updater
        {
            ...
            public function show_changelog()
            {
                ...
                if (!current_user_can('update_plugins')) {
                    wp_die(__('You do not have permission to install plugin updates', 'gravityview'), __('Error', 'gravityview'), ['response' => 403]);
                }
