...
{
    public function __construct($id = 'default_table', $settings = [], $field_options = [], $areas = [])
    {
    ...
    {
        add_filter('gravityview/admin/add_button_label', [$this, 'maybe_modify_button_label'], 10, 2);
    }
     ...
     * @return string|void
     */
    public function maybe_modify_button_label($label = '', $atts = [])
    {
