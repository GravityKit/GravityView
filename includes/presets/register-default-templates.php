...
function gravityview_register_placeholder_templates() {
	...
	$placeholders = array(
		...
		'GravityView_Maps_Template_Map_Default' => array(
			...
			'preview' => 'https://demo.gravityview.co/view/map/?utm_source=plugin&utm_medium=try_demo&utm_campaign=view_type&utm_term=map',
		...
		'GravityView_DIY_Template' => array(
			...
			'preview' => 'https://demo.gravityview.co/view/diy/?utm_source=plugin&utm_medium=try_demo&utm_campaign=view_type&utm_term=diy',
			'license' => esc_html__( 'All Access', 'gravityview' ),
			'price_id' => 2,
		),
	);
