...
class GravityView_Change_Entry_Creator {
	...
	function __construct() {
		...
		/**
		 * @hook gravityview_disable_change_entry_creator Disable the Change Entry Creator functionality
		 * @since  1.7.4
	...
	function assign_new_user_to_lead( $user_id, $config, $entry = array(), $password = '' ) {
		...
		/**
		 * @hook gravityview_disable_change_entry_creator_note Disable adding a note when changing the entry creator
		 * @since  1.21.5
