...
class GravityView_Entry_Notes {
	...
	public static function add_note( $lead_id, $user_id, $user_name, $note = '', $note_type = 'gravityview' ) {
		...
		/**
		 * @hook gravityview/entry_notes/add_note Modify note values before added using GFFormsModel::add_note()
		 * @see GFFormsModel::add_note
		 * @since 1.15.2
	...
	public static function get_notes( $entry_id ) {
		...
		/**
		 * @hook gravityview/entry_notes/get_notes Modify the notes array for an entry
		 * @since 1.15
