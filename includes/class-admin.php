...
class GravityView_Admin
{
    ...
    private function add_hooks()
    {
        ...
        add_filter('plugin_action_links_'.plugin_basename(GRAVITYVIEW_FILE), [$this, 'plugin_action_links']);

        add_action('plugins_loaded', [$this, 'backend_actions'], 100);

        add_action('gravityview/metaboxes/data-source/before', ['GravityView_Admin', 'connected_form_warning']);
    }
    ...
    public static function connected_form_warning($form_id = 0)
    {
        ...
        remove_action('gravityview/metaboxes/data-source/before', ['GravityView_Admin', 'connected_form_warning']);
    }
    ...
    public function post_updated_messages($messages, $bulk_counts = null)
    {
        ...
        $bulk_counts = is_null($bulk_counts) ? ['updated' => 1, 'locked' => 1, 'deleted' => 1, 'trashed' => 1, 'untrashed' => 1] : $bulk_counts;
     ...
     *
     * @return bool True: checks have been passed; GV is fine to run; False: checks have failed, don't continue loading
     */
     ...
     * @see GravityView_Compatibility::get_plugin_status()
     *
     * @return bool|string True: plugin is active; False: plugin file doesn't exist at path; 'inactive' it's inactive
     */
     ...
     */
    public static function is_admin_page($hook = '', $page = null)
    {
