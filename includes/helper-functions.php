...
function gravityview_format_link( $value = null ) {
	...
	/**
	 * @hook gravityview_anchor_text_striphttp Strip scheme from the displayed URL?
	 * @since 1.5.1
	...
	/**
	 * @hook gravityview_anchor_text_stripwww Strip www from the domain?
	 * @since 1.5.1
	...
	/**
	 * @hook gravityview_anchor_text_nosubdomain Strip subdomains from the domain?
	 * @since 1.5.1
	...
	/**
	 * @hook gravityview_anchor_text_rootonly Display link path going only to the base directory, not a sub-directory or file?
	 * @since 1.5.1
	...
	/**
	 * @hook gravityview_anchor_text_noquerystring Strip the query string from the end of the URL?
	 * @since 1.5.1
	 * @param boolean $enable Whether to enable "root only". Return false to show full path. (default: true)\n
...
function gravityview_get_terms_choices( $args = array() ) {
	...
	/**
	 * @hook gravityview_get_terms_choices_args Modify the arguments passed to `get_terms()`
	 * @see get_terms()
	 * @since 1.15.3
	 */
