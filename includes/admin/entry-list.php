...
class GravityView_GF_Entries_List {
	...
	function add_edit_link( $form_id = NULL, $field_id = NULL, $value = NULL, $lead = array(), $query_string = NULL ) {
		...
		<span class="edit edit_entry">
			|
		    <a title="<?php esc_attr_e( 'Edit this entry', 'gravity-view'); ?>" href="<?php echo add_query_arg( $params, admin_url( 'admin.php?page='.$query_string ) ); ?>"><?php esc_html_e( 'Edit', 'gravity-view' ); ?></a>
		</span>
		<?php
	}
