...
class GravityView_Support_Port
{
    ...
    private function add_hooks()
    {
        ...
        add_action('admin_enqueue_scripts', [$this, 'maybe_enqueue_script'], 1000);
     ...
     *
     *   @var string $id   Unique ID of article for Beacon API
     *   @var string $url  URL of support doc article
     *   @var string $type Type of Beacon element to open. {@see https://developer.helpscout.com/beacon-2/web/javascript-api/#beaconarticle}
     * }
     *
     * @param string $url
     * @param string $atts
    ...
    public static function maybe_enqueue_script($hook)
    {
         ...
         * @since 1.15
         *
         * @param bool $display_beacon Default: `true`
         */
        ...
        wp_enqueue_script('gravityview-support', plugins_url('assets/js/support'.$script_debug.'.js', GRAVITYVIEW_FILE), [], \GV\Plugin::$version, true);
    ...
    private static function _localize_script()
    {
         ...
         *
         *   @var int $contactEnabled Can the user contact support?
         *   @var array $data Support/license info
         *   @var array $translation i18n strings
         *   @var array $suggest Article IDs to recommend to the user (per page in the admin
         * }
         */
    ...
    public function user_field($user)
    {
         ...
         * @since 1.15
         *
         * @param bool    $allow_profile_setting Default: `true`, if the user has the `gravityview_support_port` capability, which defaults to true for Contributors and higher
				...
				<tbody>
					<tr class="user-gravityview-support-button-wrap">
						<th scope="row"><?php
                            ...
                            _e('GravityView Support Port', 'gravityview'); ?></th>
						<td>
							<fieldset>
								<legend class="screen-reader-text"><span><?php
                                        /* translators: "Support Port" can be translated as "Support Portal" or "Support Window" */
                                        _e('GravityView Support Port', 'gravityview'); ?></span></legend>
								<label>
