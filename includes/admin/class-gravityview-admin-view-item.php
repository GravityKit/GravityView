...
abstract class GravityView_Admin_View_Item {
	...
	function getOutput() {
		...
		$output .= '<span class="gv-field-controls">';
		...
		$output .= '<button class="gv-remove-field" aria-label="' . esc_attr( $delete_title ) . '" title="' . esc_attr( $delete_title ) . '"><span class="dashicons-dismiss dashicons"></span></button>';
