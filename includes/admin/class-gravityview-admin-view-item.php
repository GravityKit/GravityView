...
abstract class GravityView_Admin_View_Item
{
    ...
    public function __construct($title = '', $item_id = '', $item = [], $settings = [], $form_id = null)
    {
     ...
     *
     * @param bool $html Display HTML output? If yes, output is wrapped in spans. If no, plaintext.
     *
