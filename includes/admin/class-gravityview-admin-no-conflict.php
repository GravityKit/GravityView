...
class GravityView_Admin_No_Conflict
{
    ...
    private function add_hooks()
    {
        ...
        add_action('wp_print_scripts', [$this, 'no_conflict_scripts'], 1000);
        add_action('admin_print_footer_scripts', [$this, 'no_conflict_scripts'], 9);

        add_action('wp_print_styles', [$this, 'no_conflict_styles'], 1000);
        add_action('admin_print_styles', [$this, 'no_conflict_styles'], 11);
        add_action('admin_print_footer_scripts', [$this, 'no_conflict_styles'], 1);
        add_action('admin_footer', [$this, 'no_conflict_styles'], 1);
    }
     ...
     * @return void
     */
    public function no_conflict_scripts()
    {
        global $wp_scripts;
     ...
     * @return void
     */
    public function no_conflict_styles()
    {
        global $wp_styles;
    ...
    private function add_script_dependencies($registered, $scripts)
    {
        ...
        do {
            ...
            foreach ($scripts as $script) {
                $deps = isset($registered[$script]) && is_array($registered[$script]->deps) ? $registered[$script]->deps : [];
                foreach ($deps as $dep) {
