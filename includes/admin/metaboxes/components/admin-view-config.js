...
function run() {
    _react2['default'].render(_react2['default'].createElement(_adminViewDataSourceJsx2['default'], { message: 'World2' }), document.getElementById('gravityview_select_form'));
}
...
},{"./admin-view-data-source.jsx":2,"react":158}],2:[function(require,module,exports){
'use strict';
