...
},{"./admin-view-data-source.jsx":2,"./admin-view-select-template.jsx":3,"react":160}],2:[function(require,module,exports){
'use strict';
    ...
    render: function render() {
        ...
        if (this.props.form <= 0) {
            ...
            switchView = _react2['default'].createElement(
                'a',
                { className: 'button button-primary', title: gravityview_i18n.mb_ds_switch_view },
        ...
        if (gravityview_view_settings.forms.length > 0) {
            ...
            formSelect = _react2['default'].createElement(
                'select',
                { value: this.props.form, name: '', onChange: this.props.onFormChange },
...
},{"./parts/metabox.jsx":4,"react":160}],3:[function(require,module,exports){
'use strict';
...
},{"./parts/metabox.jsx":4,"react":160}],4:[function(require,module,exports){
'use strict';
