...
class GravityView_Admin_Metaboxes
{
    ...
    public function register_metaboxes()
    {
        ...
        add_meta_box('gravityview_select_template', __('Choose a View Type', 'gravityview'), [$this, 'render_select_template_metabox'], 'gravityview', 'normal', 'high');

        // View Configuration box
        add_meta_box('gravityview_view_config', __('Layout', 'gravityview'), [$this, 'render_view_configuration_metabox'], 'gravityview', 'normal', 'high');

        $this->add_settings_metabox_tabs();

        // Other Settings box
        add_meta_box('gravityview_settings', __('Settings', 'gravityview'), [$this, 'settings_metabox_render'], 'gravityview', 'normal', 'core');
    }
     ...
     * @return void
     */
    public function render_view_configuration_metabox($post)
    {
     ...
     * @return void
     */
    public function render_view_settings_metabox($post)
    {
     ...
     * @return void
     */
    public function render_shortcode_hint()
    {
        global $post;
