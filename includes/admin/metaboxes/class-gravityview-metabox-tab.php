...
class GravityView_Metabox_Tab
{
     ...
     * @return void
     */
    public function __construct($id, $title = '', $file = '', $icon_class_name = '', $callback = '', $callback_args = [])
    {
     ...
     */
    public function parse_icon_class_name($icon_class_name = '')
    {
    ...
    public function render($post)
    {
        if (!empty($this->render_template_file)) {
            ...
            if (file_exists($path)) {
                ...
                gravityview()->log->error('Metabox template file not found', ['data' => $this]);
            }
            ...
            if (is_callable($this->callback)) {
                ...
                gravityview()->log->error('Metabox callback was not callable', ['data' => $this]);
            }
        } else {
            gravityview()->log->error('Metabox file and callback were not found', ['data' => $this]);
        }
    }
}
