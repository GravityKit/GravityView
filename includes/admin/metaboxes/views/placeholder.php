...
?>
<div class="gk-gravityview-placeholder-container gk-gravityview-placeholder-container--<?php echo esc_attr( $type ); ?>">
	...
	<div class="gk-gravityview-placeholder-content">
		...
		<div class="gk-gravityview-placeholder-actions">
			...
			if ( $user_can && 'read' !== $caps ) {
				printf( '<a href="%1$s" class="gk-gravityview-placeholder-button button button-primary button-hero">%2$s</a>', esc_url( $button_href ), esc_html( $button_text ) );
			} else {
				printf(
