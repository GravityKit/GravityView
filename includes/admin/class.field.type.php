...
abstract class GravityView_FieldType
{
    ...
    public function __construct($name = '', $field = [], $curr_value = null)
    {
        $this->name = $name;
    ...
    public function get_tooltip()
    {
        ...
        $article = wp_parse_args(\GV\Utils::get($this->field, 'article', []), [
            'id'   => '',
            'type' => 'modal',
            'url'  => '#',
        ]);
     ...
     * @return string
     */
    public function tooltip($name, $css_class = '', $return = false, $article = [])
    {
     ...
     * @return string
     */
    public function get_field_left_label()
    {
     ...
     * @return bool
     */
    public function show_merge_tags()
    {
     ...
     */
    public function render_setting($override_input = null)
    {
     ...
     */
    public function render_input($override_input)
    {
        echo '';
    }
}
