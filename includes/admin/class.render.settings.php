...
class GravityView_Render_Settings
{
    ...
    public static function get_default_field_options($field_type, $template_id, $field_id, $context, $input_type, $form_id, $grouped = false)
    {
        ...
        if ($grouped) {
            ...
            foreach (self::get_field_groups() as $group_key => $group_name) {
                $field_options[$group_key] = \GV\Utils::get($option_groups, $group_key, []);
            }
        } else {
     ...
     */
    public static function render_field_options($form_id, $field_type, $template_id, $field_id, $field_label, $area, $input_type = null, $uniqid = '', $current = '', $context = 'single', $item = [])
    {
        if (empty($uniqid)) {
...
EOD;
     ...
     * @return string [html tags]
     */
    public static function render_text_option($name = '', $id = '', $current = '', $add_merge_tags = null, $args = [])
    {
     ...
     * @param string      $name           Unique name of the field. Exampe: `fields[directory_list-title][5374ff6ab128b][custom_label]`
     * @param string      $current        [current value]
     * @param string|bool $add_merge_tags Add merge tags to the input?
     * @param array       $args           Field settings, including `class` key for CSS class
     *
     * @return string [html tags]
     */
    public static function render_textarea_option($name = '', $id = '', $current = '', $add_merge_tags = null, $args = [])
    {
