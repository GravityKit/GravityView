...
?>
<div class="gv-search-box gv-search-field-checkbox <?php echo $custom_class; ?>"<?php if ( ! empty( $search_field['required_min_selection'] ) ) { ?> data-required-min-selection="1" data-required-message="<?php echo esc_attr( $search_field['required_message'] ?? __( 'Please select at least one option.', 'gk-gravityview' ) ); ?>"<?php } ?>>
