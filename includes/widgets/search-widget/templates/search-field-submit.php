...
<div class="gv-search-box gv-search-box-submit">
	...
	<input type="submit" class="button gv-search-button" data-viewid="<?php echo $view_id; ?>" gv_search_button_<?php echo $view_id; ?>" value="<?php esc_attr_e( 'Search', 'gravityview' ); ?>" />
</div>
