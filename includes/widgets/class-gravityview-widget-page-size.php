...
class Page_Size extends \GV\Widget {
	...
	public static function get_page_sizes( $context ) {
		...
		/**
		 * @hook gravityview/widget/page_size/page_sizes Filter the available page sizes as needed
	...
	public function render_frontend( $widget_args, $content = '', $context = null ) {
		...
		/**
		 * @hook gravityview/widget/page_size/settings Filter the settings for the widget
