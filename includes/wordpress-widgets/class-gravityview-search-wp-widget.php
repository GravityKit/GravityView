...
class GravityView_Search_WP_Widget extends WP_Widget
{
    public function __construct()
    {
        ...
        add_filter('gravityview_fe_search_criteria', [$gravityview_widget, 'filter_entries'], 10, 3);

        // frontend - add template path
        add_filter('gravityview_template_paths', [$gravityview_widget, 'add_template_path']);
    ...
    public function widget($args, $instance)
    {
        ...
        if (empty($instance['view_id'])) {
            gravityview()->log->debug('No View ID has been defined. Not showing the widget.', ['data' => $instance]);
