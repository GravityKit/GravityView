...
class GravityView_Recent_Entries_Widget extends WP_Widget
{
    ...
    private function initialize()
    {
        ...
        add_action('wp_ajax_gv_get_view_merge_tag_data', [$this, 'ajax_get_view_merge_tag_data']);
    }
     ...
     * @since 1.6
     */
    public function ajax_get_view_merge_tag_data()
    {
    ...
    public function admin_enqueue_scripts()
    {
        ...
        if ($pagenow === 'widgets.php') {
            ...
            wp_enqueue_script('gravityview_widgets', plugins_url('assets/js/admin-widgets'.$script_debug.'.js', GRAVITYVIEW_FILE), ['jquery', 'gform_gravityforms'], GravityView_Plugin::version);

            wp_localize_script('gravityview_widgets', 'GVWidgets', [
                'nonce' => wp_create_nonce('gravityview_ajax_widget'),
            ]);

            wp_enqueue_style('gravityview_views_styles', plugins_url('assets/css/admin-views.css', GRAVITYVIEW_FILE), ['dashicons'], GravityView_Plugin::version);
        }
    }
    ...
    public function form($instance)
    {
        ...
        echo ' '.gravityview_get_link('https://docs.gravityview.co/article/222-the-search-widget', __('Learn more&hellip;', 'gravityview'), 'target=_blank'); ?></span>
		</p>
