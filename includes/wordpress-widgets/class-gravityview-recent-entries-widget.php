...
class GravityView_Recent_Entries_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		/**
		 * @hook gravityview/widget/recent-entries/before_widget Before recent entries are displayed in the WordPress widget
		 * @param array $args     Display arguments including before_title, after_title, before_widget, and after_widget.
		 * @param array $instance The settings for the particular instance of the widget.
		 */
		...
		/**
		 * @hook gravityview/widget/recent-entries/after_widget After recent entries are displayed in the WordPress widget
		 * @param array $args     Display arguments including before_title, after_title, before_widget, and after_widget.
		 * @param array $instance The settings for the particular instance of the widget.
		 */
	...
	public function form( $instance ) {
		...
		/**
		 * @hook gravityview_recent_entries_widget_form Displayed at the bottom of the Recent Entries widget admin form
