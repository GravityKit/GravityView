...
return array(
    ...
    'Codeception\\' => array($vendorDir . '/codeception/stub/src', $vendorDir . '/lucatume/wp-browser/src/Codeception', $vendorDir . '/codeception/codeception/src/Codeception'),
    'Carbon\\' => array($vendorDir . '/nesbot/carbon/src/Carbon'),
    'BrianHenryIE\\Strauss\\' => array($vendorDir . '/brianhenryie/strauss/src'),
    '' => array($vendorDir . '/wp-cli/core-command/src', $vendorDir . '/wp-cli/extension-command/src', $vendorDir . '/wp-cli/scaffold-command/src', $vendorDir . '/wp-cli/widget-command/src', $vendorDir . '/wp-cli/super-admin-command/src', $vendorDir . '/wp-cli/shell-command/src', $vendorDir . '/wp-cli/server-command/src', $vendorDir . '/wp-cli/search-replace-command/src', $vendorDir . '/wp-cli/role-command/src', $vendorDir . '/wp-cli/rewrite-command/src', $vendorDir . '/wp-cli/package-command/src', $vendorDir . '/wp-cli/media-command/src', $vendorDir . '/wp-cli/language-command/src', $vendorDir . '/wp-cli/import-command/src', $vendorDir . '/wp-cli/export-command/src', $vendorDir . '/wp-cli/eval-command/src', $vendorDir . '/wp-cli/entity-command/src', $vendorDir . '/wp-cli/db-command/src', $vendorDir . '/wp-cli/cron-command/src', $vendorDir . '/wp-cli/config-command/src', $vendorDir . '/wp-cli/checksum-command/src', $vendorDir . '/wp-cli/cache-command/src'),
);
