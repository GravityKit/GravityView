...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('GravityView\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('GravityView\Psr\Log\Test\DummyTest', array('__toString'));
        }
