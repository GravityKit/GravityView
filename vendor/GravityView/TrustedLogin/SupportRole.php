...
final class SupportRole {
	...
	/**
	 * @var array These capabilities will never be allowed for users created by GravityView\TrustedLogin
	 * @since 0.9.6
	 */
	...
	public function create( $new_role_slug = '', $clone_role_slug = '' ) {
		...
		// These roles should never be assigned to GravityView\TrustedLogin roles.
