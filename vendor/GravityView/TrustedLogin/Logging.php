...
use GravityView\Katzgrau\KLogger\Logger;
...
class Logging {
	...
	private function prevent_directory_browsing( $dirpath ) {
		...
		fwrite( $file, '<!-- Silence is golden. GravityView\TrustedLogin is also pretty great. -->' );
		fclose( $file );
	...
	public function is_enabled() {
		...
		/**
		 * Filter: Whether debug logging is enabled in GravityView\TrustedLogin Client
		 *
		 * @since 0.4.2
		 *
