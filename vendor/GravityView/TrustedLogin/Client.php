<?php
/**
 * The GravityView\TrustedLogin drop-in class. Include this file and instantiate the class and you have secure support.
 *
 * @version 0.9.2
 ...
 *
 * 0. If you haven't already, sign up for a GravityView\TrustedLogin account {@see https://www.trustedlogin.com}
...
final class Client {
	...
	/**
	 * GravityView\TrustedLogin constructor.
	 *
	...
	/**
	 * This creates a GravityView\TrustedLogin user ✨
	 *
	...
	public function grant_access() {
		...
		if ( ! self::$valid_config ) {
			return new WP_Error( 'invalid_configuration', 'GravityView\TrustedLogin has not been properly configured or instantiated.', array( 'error_code' => 424 ) );
		}
	...
	private function extend_access( $user_id ) {
		...
		try {
			...
			$this->logging->log( 'There was an error updating GravityView\TrustedLogin servers.', __METHOD__, 'error', $e );
