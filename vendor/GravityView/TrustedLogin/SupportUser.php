...
final class SupportUser {
	...
	/**
	 * @var int $created_by_meta_key The ID of the user who created the GravityView\TrustedLogin access
	 * @since 0.9.7
	 */
	 ...
	 * @param bool   $delete_endpoint Should the GravityView\TrustedLogin endpoint for the site be deleted also? Default: `true`
	 *
